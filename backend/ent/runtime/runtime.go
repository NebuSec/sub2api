...
func init() {
	...
	// usagelogDescVegaScanID is the schema descriptor for vega_scan_id field.
	usagelogDescVegaScanID := usagelogFields[7].Descriptor()
	// usagelog.VegaScanIDValidator is a validator for the "vega_scan_id" field. It is called by the builders before save.
	usagelog.VegaScanIDValidator = usagelogDescVegaScanID.Validators[0].(func(string) error)
	// usagelogDescVegaProjectID is the schema descriptor for vega_project_id field.
	usagelogDescVegaProjectID := usagelogFields[8].Descriptor()
	// usagelog.VegaProjectIDValidator is a validator for the "vega_project_id" field. It is called by the builders before save.
	usagelog.VegaProjectIDValidator = usagelogDescVegaProjectID.Validators[0].(func(string) error)
	// usagelogDescVegaRequestID is the schema descriptor for vega_request_id field.
	usagelogDescVegaRequestID := usagelogFields[9].Descriptor()
	// usagelog.VegaRequestIDValidator is a validator for the "vega_request_id" field. It is called by the builders before save.
	usagelog.VegaRequestIDValidator = usagelogDescVegaRequestID.Validators[0].(func(string) error)
	// usagelogDescVegaRunnerID is the schema descriptor for vega_runner_id field.
	usagelogDescVegaRunnerID := usagelogFields[10].Descriptor()
	// usagelog.VegaRunnerIDValidator is a validator for the "vega_runner_id" field. It is called by the builders before save.
	usagelog.VegaRunnerIDValidator = usagelogDescVegaRunnerID.Validators[0].(func(string) error)
