...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "vega_scan_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "vega_project_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "vega_request_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "vega_runner_id", Type: field.TypeString, Nullable: true, Size: 128},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_vega_scan_id",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[5]},
			},
			{
				Name:    "usagelog_vega_project_id",
				Unique:  false,
			...
			{
				Name:    "usagelog_vega_scan_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[5], UsageLogsColumns[40]},
			},
			{
				Name:    "usagelog_vega_project_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[6], UsageLogsColumns[40]},
			},
			{
