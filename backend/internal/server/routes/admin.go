...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/:id/keys", h.Admin.UserBilling.CreateUserAPIKey)
		users.GET("/:id/billing-summary", h.Admin.UserBilling.GetBillingSummary)
		users.POST("/:id/billing-eligibility", h.Admin.UserBilling.CheckBillingEligibility)
